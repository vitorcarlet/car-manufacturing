...
@NamedQuery(name = "UserPermissionsEntity.findByLogin", query = "select new UserCredentialsEntity(u.id,u.login,u.senha,u.userId) from UserCredentialsEntity u where u.login=:login")
